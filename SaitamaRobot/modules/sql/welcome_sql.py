...
from SpongebobBot.modules.helper_funcs.msg_types import Types
from SpongebobBot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Hi, {first}, show me your Krusty License!",  #spongebob
    "I'm looking for Patrick, oh wait nvm it's {first}.",  #spongebob
    "Welcome {first}, leaving is not an option!",
    "Run Forest! ..I mean...{first}.",
    "{first} Let's Cook Krabby Patty!",  #spongebob
    "Huh?\nDid someone with a disaster level just join?\nOh wait, it's just {first}.",  #One Punch ma 
    "Hey, {first}, ever heard the Squidward Engine?",  #spongebob
    ...
    "{first} just arrived. Give him a krabby patty!",  #One Piece Sanji
    "{first} just arrived. Let's play!",  #No Game No Life
    ...
    "I... am... Whitebeard!...wait..wrong Film.",  #one Piece
    ...
    "Ay ay captain!",  #Tokyo Ghoul
    "Ready captain!...nvm wrong anime.",  #op
